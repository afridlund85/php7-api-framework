...
class AsdTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->app->addRoute(new Route('GET', 'path', new MethodCallback('Test\Fakes', 'FakeClass', 'action')));
        $this->app->run();
    ...
    {
        $this->app->addRoute(new Route('GET', 'path', new MethodCallback('Test\Fakes', 'FakeClassDep', 'action')));
        $this->app->run();
        $this->expectOutputString('Some value');
    }
    ...
    {
        $this->app->addRoute(new Route('GET', 'path', new MethodCallback('Test\Fakes', 'FakeClass', 'jsonAction')));
        $this->app->run();
    ...
    {
        $this->app->addRoute(new Route('GET', 'path', new FunctionCallback(function($req, $res, \Test\Fakes\FakeDependency $dep){
            $dep->setValue('Hi');
